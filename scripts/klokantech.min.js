...
!1)}},a),void 0,{enableHighAccuracy:!0}))):(a.ma.setVisible(!1),a.Z.setVisible(!1));a.Ib.style.backgroundPosition=b?"-30px":"";a.enabled=b}}
v("klokantech.GeolocationControl",function(a,b,c){this.map=a;navigator.geolocation&&"https:"==location.protocol&&(this.Ib=$a("div",{style:"background-size:60px 30px;width:30px;height:30px;opacity:0.9;background-image:url(https://cdn.klokantech.com/maptilerlayer/v1/geolocation.png);"}),this.element=$a("div",{style:"background-color:#fff;border:2px solid #fff;border-radius 3px;box-shadow:rgba(0,0,0,0.298039) 0 1px 4px -1px;margin-right:10px;margin-bottom:10px;cursor:pointer;border-radius:2px;padding:3px;"},this.Ib),this.xb=
